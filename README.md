# Portfolio de proyectos de datos

Este repositorio contiene mis proyectos de datos enfocados en:

- **Deportes**: análisis de partidos, rendimiento y lesiones de jugadores.  
- **Análisis de reseñas**: análisis de reseñas de un restaurante en google y tripadvisor.
...
|--------------------------------------|----------------------------------------|--------------------|
| Lesiones de jugadores de fútbol      | Deportes                               | Reducir bajas médicas |
| Churn en clubes empresas             | Fuga de clientes                       | Retener socios/miembros |
